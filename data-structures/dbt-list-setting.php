...
class DbtDs_list_setting 
{
    ...
    public function __get($property) {
        if (property_exists($this, $property)) {
            ...
            trigger_error('DbtDs_list_setting: GET '.$property. " NOT EXISTS ", E_USER_WARNING);
        }
    }
     ...
     *```php
     * (new DbtDs_list_setting())->set_from_array($vars);
     *```
     * @param array $array
...
/**
  * DbtDs_list_delete La struttura per la rimozione di un campo
  * Qui si può aprire un mondo sulle condizioni per poter cancellare un campo, 
  * eventuali tabelle collegate ecc...
  */
class DbtDs_list_delete_params extends DbtDs_data_structures
{
