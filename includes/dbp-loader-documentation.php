...
class  Dbp_loader_documentation {
	public function __construct() {
		add_action( 'wp_ajax_dbp_get_documentation', [$this, 'fn_get_documentation'] );   
	}
	...
	public function fn_get_documentation() {
		require_once(__DIR__.'/dbp-function-documentation.php');
		...
		if ($get_page != "" ) {
			...
			if (substr($get_page, 0, 8) == "dbp_docs") {
				$get_page = "dbp_docs-menu.php";
			}
			if ( is_file($dir_scan . "/" . $get_page) ) {
				...
				ob_start();
				?>
				<div class="dbp-content-margin dbp-sidebar-breadcrumb">
					<?php
