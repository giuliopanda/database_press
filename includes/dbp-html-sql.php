 ...
 class  Dbp_html_sql {
    ...
    static private function render_html_btns() {
        ...
        <div class="dbp-result-query-btns js-result-query-btns">
            <?php 
            $btns['edit_inline'] = 
            '<div id="dbp-bnt-edit-query" class="button dbp-btn-show-sql-view" onclick="show_sql_query_edit()">'. __('Edit inline','database_press').'</div>';
      
            $btns['cancel'] =
            '<div id="dbp-bnt-cancel-query"  class="button dbp-btn-show-sql-edit"  onclick="hide_sql_query_edit()">'. __('Cancel','database_press').'</div>';
       
            $btns['organize'] =
            '<div id="dbp-bnt-columns-query" class="button js-show-only-select-query dbp-btn-disabled js-btn-disabled"  onclick="dbp_columns_sql_query_edit()">'. __('Organize columns','database_press').'</div>';

            $btns['merge'] =
            '<div id="dbp-bnt-merge-query" class="button js-show-only-select-query dbp-btn-disabled js-btn-disabled"  onclick="dbp_merge_sql_query_edit()">'. __('Merge','database_press').'</div>';

            $btns['metadata'] =
            '<div id="dbp-bnt-metadata-query" class="button js-show-only-select-query js-show-only-metada-query dbp-btn-disabled js-btn-disabled"  onclick="dbp_metadata_sql_query_edit()">'. __('Add meta data','database_press').'</div>';
