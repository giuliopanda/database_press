		...
		<thead>
			<tr>
				...
				foreach ($array_thead as $key => $value) {
					?>
					<th class="dtf-table-th">
						<div class="dtf-table-th-content">
							<div class="dtf-table-title"><?php echo $key; ?></div> 
						</div>
					</th>
					<?php 
				} 
		...
		<?php foreach ($items as $item) : 
			...
			<tr>
				...
				foreach ($array_thead as $key=>$_) { 
					?><td class="dtf-table-td><div class="btn-div-td"><?php echo $item->$key; ?></div></td> <?php
				} 
				?>
			</tr>
		<?php endforeach; ?>
