...
class  Dbp_html_table {
	...
	public function template_render($table_model) {
		...
		if ($table_model->last_error !== false) {
			...
			?><div class="dbp-alert-gray"><?php echo sprintf(__('MySQL returned %s rows. (Query took %s seconds.)', 'database_press'), $table_model->effected_row,  $table_model->time_of_query ); ?></div><?php 
		}
