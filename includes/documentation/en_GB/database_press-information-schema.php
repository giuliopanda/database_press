...
<div class="dbp-content-margin">
    <p> Show all Database Press. Wordpress tables have a prefix that identifies them. Not all tables can be modified, this depends on their state. </p>
    ...
    <a class="js-simple-link" href="<?php echo admin_url("admin.php?page=dbp_docs&section=hooks") ?>" target="_blank">Learn more: Hooks & filters</a>
</div>