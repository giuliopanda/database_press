...
<div class="dbt-content-table dbt-docs-content  js-id-dbt-content dbt-tutorial"  >
    ...
    <h2 class="dbt-h2">Creazione della lista</h2>
    <p>In Database_tables nel menu di destra dentro database tables actions clicchiamo sul link "SQL Command".</p>
    ...
    <h2 class="dbt-h2">Pubblicazione</h2>
	...
	$append = '';
	if (is_single()) {
		$append = DatabaseTables\Dbt::get_list('113');
	}
	return $content.$append;
}
add_filter('the_content', 'add_dbt_list_to_content');</pre>

<h2 class="dbt-h2">Impostazioni avanzate</h2>
