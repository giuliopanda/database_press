...
<div class="dbt-help-p">
    ...
    <p>Puoi altrimenti eseguire le istruzioni del template engine attraverso lo shortcode <b>dbt_tmpl_engine</b>. Aggiungi dall'editor un blocco shortcode e scrivi:
...
[^RETURN [%c.1]] [// output 3 //]
  ...
  <h3>[^RETURN]</h3>
    ...
    <h3>[^LIST_URL]</h3>
    <p>Paramentri pri=[%primaries], dbt_id=xx, action=""</p>
    <div class="dbt-help-p">
