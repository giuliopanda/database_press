...
<div class="dbp-help-p">
    ...
    <p>Puoi altrimenti eseguire le istruzioni del template engine attraverso lo shortcode <b>dbp_tmpl_engine</b>. Aggiungi dall'editor un blocco shortcode e scrivi:
...
[^RETURN [%c.1]] [// output 3 //]
  ...
  <h3>[^RETURN]</h3>
    ...
    <p>Estrae i dati di una lista specifica</p>
