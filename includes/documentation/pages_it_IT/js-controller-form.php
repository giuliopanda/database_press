...
<h2 class="dbp-h2"> <a href="<?php echo admin_url("admin.php?page=dbp_docs") ?>">Doc</a><span class="dashicons dashicons-arrow-right-alt2"></span><?php _e('LIST FORM js script','database_press'); ?></h2>
    ...
    <p>Puoi usare la variabile <b>field</b> per riferirti al campo in cui stai scrivendo il codice. Questa variabile estende l'oggetto dbp_field che ha le seguenti funzioni:</p> 
    ...
    <p>Puoi fare riferimento agli altri campi della form attraverso la variabile form che estend dbp_form</p> 
            <ul>
