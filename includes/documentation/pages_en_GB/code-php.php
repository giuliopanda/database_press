...
<div class="dbt-content-table dbt-docs-content  js-id-dbt-content" >
    ...
    <div class="dbt-help-p">
        ...
        <p>Carica una lista da un id e ne ritorna l'html. Praticamente la stessa cosa che fa lo shortcode!</p>
        ...
        <h2 class="dbt-h2">Dbt::get_data_from_id($dbt_id, $dbt_ids)</h2>
        <p>Ritornano i dati o il model di una lista</p>
        <h4 class="dbt-h4">Parameters</h4>
        <ul>
                <li><b>$dbt_id</b><br>
