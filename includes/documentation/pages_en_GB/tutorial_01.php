...
<div class="dbp-content-table dbp-docs-content  js-id-dbp-content dbp-tutorial"  >
    ...
    <p>In database_press in the menu on the right inside the tab "Database Press actions" click on the link "SQL Command".</p>
	...
	$append = '';
	if (is_single()) {
		$append = DatabasePress\Dbp::get_list({list_id});
	}
	return $content.$append;
}
add_filter('the_content', 'add_dbp_list_to_content');</pre>

<h2 class="dbp-h2">Advanced settings</h2>
