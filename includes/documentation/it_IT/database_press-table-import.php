...
<div class="dbp-content-margin">
    ...
    <div id="dbp_help_sql" class="dbp_help_div">
        <p>I file sql vengono eseguiti senza fare nessun controllo sui dati.</p>
    </div>
    <div id="dbp_help_csv" class="dbp_help_div">
    ...
    <div id="dbp_help_delimiter" class="dbp_help_div">
        <ul>
    ...
    <div id="dbp_help_choose_action" class="dbp_help_div">
        <h3>Choose Action</h3>
        <div id="dbp_help_create_table" class="dbp_help_div">
            <h4>Create table</h4> 
            <p>Crei una tabella nel database a partire dalle colonne del csv. Sceglierai in un secondo momento quali campi associare. </p>
        </div>
        <div id="dbp_help_insert_record" class="dbp_help_div">
