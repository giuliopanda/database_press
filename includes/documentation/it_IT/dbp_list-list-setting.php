...
<div class="dbp-content-margin">
    <div id="dbp_help_list_of_records" class="dbp_help_div">
        Ogni lista può essere visualizzata nel frontend attraverso uno shortcode, o richiamata da codice php. Puoi infatti chiamare il filtro <a class="js-simple-link" href="<?php echo admin_url("admin.php?page=dbp_docs&section=hooks") ?>" target="_blank">dbp_frontend_get_list</a> per ridisegnarne il contenuto.<br>
        Esistono due tipi di visualizzazioni che puoi generare, o una tabella o puoi disegnare la tua visualizzazione attraverso il <a class="js-simple-link" href="<?php echo admin_url("admin.php?page=dbp_docs&section=pinacode") ?>" target="_blank">template engine integrato</a>.
    </div>
