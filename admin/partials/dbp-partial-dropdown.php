 ...
 */
?>
    <div class="dbp-table-sort <?php echo $sort_desc_class ; ?>" data-dbp_sort_key="<?php echo esc_attr($original_field_name); ?>" data-dbp_sort_order="DESC"><?php _e('Sort Desending', 'database_press'); ?></div>
    <div class="dbp-table-sort <?php echo $sort_asc_class ; ?>" data-dbp_sort_key="<?php echo esc_attr($original_field_name); ?>" data-dbp_sort_order="ASC"><?php _e('Sort Ascending', 'database_press'); ?></div>
    <div class="dbp-table-sort <?php echo $sort_remove_class ; ?>" ><?php _e('Remove sort', 'database_press'); ?></div>
<?php endif; ?>
<?php /* ricerca */ ?>
<?php if ($original_field_name != "" && $filter !== false) : ?>
    ...
    <?php if ($def_input_value != "" || @$def_input_value_2 != "" || $default_value != "") : ?>
        <div class="js-remove-filter dbp-dropdown-line-click" data-rif="<?php echo esc_attr($name_column); ?>"><?php _e('Remove Filter', 'database_press'); ?></div>
    <?php else: ?>
        <div class="dbp-dropdown-line-disable" data-rif="<?php echo esc_attr($name_column); ?>"><?php _e('Remove Filter', 'database_press'); ?></div>
    <?php endif; ?>
    <div class="dbp-dropdown-hr"></div>
    ...
    <textarea name="filter[search][<?php echo esc_attr($name_column); ?>][value]" id="dbp_dropdown_search_value_<?php echo $name_column; ?>" style="display:none"><?php echo esc_textarea(stripslashes($default_value)); ?></textarea>
    ...
    <div class="dbp-dropdown-line-flex" id="dbp_input_value_box_<?php echo $name_column; ?>">
        <span class="dbp-filter-label"><?php _e('Value', 'database_press'); ?></span>
        <?php if ($symple_type == "DATE") : ?>
            <input class="dbp-table-filter js-table-filter-input-value" id="dbp_input_value_<?php echo $name_column; ?>" type="date" data-rif="<?php echo $name_column; ?>"  value="<?php echo esc_attr(str_replace(" ", "T", $def_input_value)); ?>">
        <?php else : ?>
    ...
    <div class="dbp-dropdown-line-flex" id="dbp_input_value2_box_<?php echo $name_column; ?>">
        <span class="dbp-filter-label"><?php _e('Value 2', 'database_press'); ?></span>
        <?php if ($symple_type == "DATE") : ?>
            <input class="dbp-table-filter js-table-filter-input-value2" id="dbp_input_value2_<?php echo $name_column; ?>" type="date" data-rif="<?php echo $name_column; ?>"  value="<?php echo esc_attr(str_replace(" ", "T", $def_input_value_2)); ?>">
        <?php else : ?>
            <input class="dbp-table-filter js-table-filter-input-value2" data-rif="<?php echo $name_column; ?>"  id="dbp_input_value2_<?php echo $name_column; ?>" type="text"  value="<?php echo esc_attr($def_input_value_2); ?>" >
        <?php endif; ?>
    ...
    <div id="dbp_choose_values_box_<?php echo $name_column; ?>">
      

        <?php /*
        <div class="dbp-dropdown-line-flex" id="dbp_input_filter_checkboxes_row_<?php echo $name_column; ?>">
            <span class="dbp-filter-label"><?php _e('fast filter', 'database_press'); ?></span>
            <input class="dbp-table-filter js-table-filter-input_filter_checkboxes" data-rif="<?php echo $name_column; ?>"  id="dbp_input_filter_checkboxes_<?php echo $name_column; ?>" type="text"  >
        </div>
        */ ?>
        ...
        <?php
        dbp_fn::html_select(['IN'=>'Choose values', 'NOT IN'=>'Exclude values'], true, ' class="js-table-filter-select-op-partial dbp-small-select-for-checkbox" id="js_tf_select_op_'.$name_column.'_2" data-rif="'.$name_column.'"', $def_op);
        ?>
        <div class="dbp-dropdown-de-select-click js-dropdown-select-all-checkboxes" data-rif="<?php echo $name_column; ?>"><?php _e('Select all', 'database_press'); ?></div>
        <div class="dbp-dropdown-de-select-click js-dropdown-deselect-all-checkboxes" data-rif="<?php echo $name_column; ?>"><?php _e('Deselect all', 'database_press'); ?></div>
        </div>

        <div class="js-table-filter-checkbox-values" id="dbp_checkboxes_value_<?php echo $name_column; ?>" data-rif="<?php echo $name_column; ?>" data-column="<?php echo esc_attr($original_field_name); ?>">
            <ul class="dbp_dropdown_line_checkboxes_search" id="dbp_checkboxes_ul_<?php echo $name_column; ?>" data-rif="<?php echo $name_column; ?>">
                <li><label>Loading ...<label></li>
            </ul>
        </div>
        <div class="dbp-dropdown-info-count-checkboxes" id="dbp_dd_count-cb_<?php echo $name_column; ?>">
    ...
    <div class="dbp-dropdown-line dbp-dropdown-line-right">
        <div class="button dbp-btn-search js-dbp-btn-search"  data-rif="<?php echo $name_column; ?>"><?php _e('OK', 'database_press'); ?></div>
        <div class="button dbp-btn-search js-dbp-dropdown-btn-cancel"><?php _e('Cancel', 'database_press'); ?></div>
    </div>
<?php endif;
