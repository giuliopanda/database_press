...
<table class="wp-list-table widefat striped dbp-table-view-list js-dragable-table">
    <thead>
        <tr>
            ...
            <th><?php _e('Name','database_press'); ?></th>
            <th><?php _e('Preset','database_press'); ?></th>
            <th><?php _e('Action','database_press'); ?></th>
            <th><?php _e('Type','database_press'); ?></th>
            <th><?php _e('Length','database_press'); ?></th>
            <th><?php _e('Attributes','database_press'); ?></th>
            <th><?php _e('Default','database_press'); ?></th>
            <th style="width:1%"><?php _e('Null','database_press'); ?></th>
            <th title="<?php _e('Primary Key & Auto increment','database_press'); ?>"><?php _e('Pri','database_press'); ?></th>
    ...
    <tr class="js-clore-master">
        ...
        <td>
            <div class="button"  onClick="dbp_alter_table_delete_row(this);"><?php _e('Delete' , 'database_press'); ?></div>
        </td>
        <td>
    ...
    <tr>
        <td colspan="10">
            <div onclick="dbp_alter_add_row(this, '<?php echo @$max_row_allowed; ?>')" class="button"><?php _e('Add row', 'database_press'); ?></div>
        </td>
    </tr>
</table>
<div id="dbp_content_button_create_form_msg_no_primary" class="dbp-alert-sql-error" style="display:none">
    <?php _e('This system works with tables that have only one field set as the autoincrement primary key!','database_press'); ?>
</div>
</div>
